...
<template>
    <div class="detailed_information">
        <!--<el-dialog :modal="false" top="0.5vh" width="770px" class="task_box_big" :lock-scroll="true" :close-on-click-modal="false"-->
        ...
        >
          <div class="infobox">
            ...
            <!--图片1-->
              <div class="topimgbox">
                <img :src=taskInfoDialog.data.imgurl alt="">
              </div>
            <!--标题-->
            ...
            <div class="rectification" v-for="item in this.taskinfobox">
               <!--整改信息-->
                ...
                <!--图片集合2-->
                <div class="rectification_imgbox">
