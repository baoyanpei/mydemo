      ...
      <el-col :span="24">
        <div class="top">
          ...
          <el-button
            ...
            class="topright"
          >查看所有{{this.indexlabel}}地图位置</el-button>
        </div>
        <el-tabs :tab-position="tabPosition" @tab-click="handleClick">
          <el-tab-pane v-for="item in this.equipmentbox" :label="item.name" :key="item.id">
            <div class="equiptop">
            ...
            <el-tabs v-model="activeName" type="card" @tab-click="smallhandleClick">
              ...
              <el-tab-pane label="巡检记录" name="third">
                ...
                >
                  ...
                  <el-table-column prop="eleid" label="序号" width="80"></el-table-column>
                  <el-table-column label="巡检人员" prop="person_name" width="80"></el-table-column>
                  <el-table-column label="检查时间" prop="check_time" width="180"></el-table-column>
                  <el-table-column label="巡检记录" style="text-align: center;">
                    <el-table-column prop="count" label="巡检事项" width="100"></el-table-column>
                    <el-table-column prop="passed" label="合格" width="100"></el-table-column>
                    <el-table-column prop="unpass" label="不合格" style width="100"></el-table-column>
                  </el-table-column>
                  <el-table-column prop="statespan" label="状态" width="150" align="center"></el-table-column>
                  <el-table-column label="操作" width="180">
                    <template slot-scope="scope">
                      <div>
                        <el-button type="text" size="small" @click="previewfnc(scope.row)">
                          <i class="el-icon-view">预览</i>
                        </el-button>
                        <el-button type="text" size="small" @click="downloadfnc(scope.row)">
                          <i class="el-icon-download">下载打印</i>
                        </el-button>
                      </div>
                    </template>
                  </el-table-column>
              ...
              <el-tab-pane label="标定BIM位置" name="fourth">
                <el-table :data="bimdata" style="width: 100%" max-height="250">
                  ...
                  <el-table-column label="操作" width="120">
                    <template slot-scope="scope">
                      <el-button
                        @click.native.prevent="deleteRow(scope.$index, bimdata)"
                        type="text"
                        size="small"
                      >移除</el-button>
                      <el-button
...
export default {
  ...
  methods: {
    ...
    map() {
      ...
      var label = new BMap.Label('我是兰州市政府', {
