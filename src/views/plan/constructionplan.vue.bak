<template>
  <div style="margin-top: 20px">
    <el-row :gutter="10">
      ...
      <el-col :span="20">
        <!--顶部导航栏-->
        <div class="boxtop" style="position: relative">
          <div class="boxtop_left">
            ...
            >施工计划>计划列表>{{this.bannertitle}}</span>
          </div>
        ...
        <div class="block" style="float: left;background-color: #DFDFDF">
          <el-timeline :reverse="reverse">
            <el-timeline-item v-for="(activity, index) in activities" :key="index" class="linespan">
              <span
                style="position: absolute;top: -6px;left: 30px;white-space: nowrap;overflow: hidden;display: inline-block;text-overflow: ellipsis;width: 170px;"
            ...
            <div class="planboxtop">
              <div class="planboxtop_left" style="width: 590px;height: 100%;float: left">
                <div class="planboxtop_left_1" style="width: 100%;height: 50%;;overflow: hidden">
                  ...
                  <div
                    class="comments"
                    style="width: 80px;height:30px;margin-top:10px;border: 1px solid #BABABA;float: left;text-align: center;line-height: 30px;color: #BABABA;margin-left: 15px"
                  >
                    <i class="el-icon-chat-square"></i>
                    <span>评论</span>
                  </div>
                  <h1
                    style="font-size: 20px;margin-left: 15px;float: left;color: #000000;margin-top: 15px;white-space: nowrap;overflow: hidden;display: inline-block;text-overflow: ellipsis;width: 300px;"
                  >{{item.title}}</h1>
                </div>
                <div class="planboxtop_left_2" style="width: 100%;height: 50%;overflow: hidden">
                  ...
                  <span
                    style="line-height: 30px;display: block;float: left;margin-top: 10px;margin-left: 15px;font-size: 14px;"
                  >
                    <i class="el-icon-coin"></i>计划类别:施工计划
                  </span>
                  <span
                    style="line-height: 30px;display: block;float: left;margin-top: 10px;margin-left: 15px;font-size: 14px;"
                  >
              ...
              <div
                ...
                style="position:relative;width: 120px;height: 80px;background-color: #F2F2F2;float: left;margin-top: 10px;"
              >
                <span
                  class="implementation_span1"
                  style="font-size: 40px;position: absolute;bottom: 15px;left: 0px;"
                >{{span1}}</span>
                <span
              ...
              <div
                class="implementation"
                style="position:relative;color:#fff;width: 120px;margin-left:10px;height: 80px;background-color: #1ABC9C;float: left;margin-top: 10px;"
              >
                <span
                  class="implementation_span1"
                  style="font-size: 40px;position: absolute;bottom: 15px;left: 0px;"
              ...
              <div
                class="implementation"
                style="position:relative;color:#fff;width: 120px;margin-left:10px;height: 80px;background-color: #BC0000;float: left;margin-top: 10px;"
              >
                <span
                  class="implementation_span1"
                  style="font-size: 40px;position: absolute;bottom: 15px;left: 0px;"
