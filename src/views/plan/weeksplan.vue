    ...
    <div style="margin-top: 20px">
      <el-row :gutter="10">
        ...
        <el-col :span="20">
          <!--顶部导航栏-->
          <div class="boxtop">
            <div class="boxtop_left"><span style="margin-left: 15px;line-height: 35px;white-space: nowrap;display:inline-block;overflow: hidden;;text-overflow: ellipsis;width: 300px;">周计划>计划列表>{{this.bannertitle}}</span></div>
                ...
                <div class="planboxtop">
                  <div class="planboxtop_left" style="width: 590px;height: 100%;float: left">
                    ...
                    <div class="planboxtop_left_2" style="width: 100%;height: 50%;overflow: hidden">
                      ...
                      <span style="line-height: 30px;display: block;float: left;margin-top: 10px;margin-left: 15px;font-size: 14px;"><i class="el-icon-coin"></i>计划类别:周计划</span>
