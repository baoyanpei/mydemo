    ...
    <el-row :gutter="10">
      ...
      <el-col :span="20">
        <div class="grid-content bg-purple-light input-form">
          <el-divider content-position="center"><h2>材料出库</h2></el-divider>
            ...
            <div class="input-from-sum">
              <p>一、基本信息 <span v-show="itemShow" @click="showAndHidden">+</span><span v-show="!itemShow" @click="showAndHidden">-</span></p>
                  <div style="padding-left: 25px;" v-show="itemShow">
                      ...
                      <el-form-item label="出库编号:" style="width:400px" prop="code">
            ...
            <div>
              ...
              <el-table
                ...
                <el-table-column  label="含税单价" width="180">
                  <template slot-scope="scope">
                    <el-select v-model="scope.row.taxprice" @change="getColumns(scope.row,'taxprice',scope.row.taxprice)" placeholder="选择含税单价">
                      <el-option v-for="(item,index) in taxpriceList" :key="index" :label="item.name" :value="item.id"></el-option>
                    </el-select>
                  </template>
                </el-table-column>
                <el-table-column label="分配用途" sortable width="180">
                  <template slot-scope="scope">
                    <el-select v-model="scope.row.use"  placeholder="请选择用途">
                      <el-option label="主要材料" value="1"></el-option>
                      <el-option label="辅助材料" value="2"></el-option>
                      <el-option label="临设费" value="3"></el-option>
                      <el-option label="文明施工" value="4"></el-option>
                      <el-option label="环保费" value="5"></el-option>
                      <el-option label="安全施工" value="6"></el-option>
                      <el-option label="设备料" value="7"></el-option>
                    </el-select>
                  </template>
                </el-table-column>
                ...
                <el-table-column label="含税小计" width="180">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.taxprices" @change="getColumns(scope.row,'taxprice',scope.row.taxprices)"></el-input>
                  </template>
                </el-table-column>
              ...
              submitData(formName) {
                  ...
                  this.$refs[formName].validate((valid) => {
                      if (valid) {
                          ...
                          this.sumData.method="material_outstock";
                          submitMaterial(this.sumData).then(res=>{
                             ...
                             //提交成功
                              ...
                              const condition={"categoryId":this.form.category,"inorout":2,"proId":this.project_id,"code":this.form.code};
