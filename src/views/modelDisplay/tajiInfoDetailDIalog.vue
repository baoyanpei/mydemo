...
<template>
  ...
  <div id="taji-info-detail-dialog" class="taji-info-detail-dialog">
    <el-dialog :modal="false" width="600px" top="10vh" :lock-scroll="true" :close-on-click-modal="false"
      :close-on-press-escape="true" :visible.sync="TajiInfoDetailDialog.show" @opened="openedDialogHandle"
      @close="closeDialogHandle" :title="dialogTitle" v-el-drag-dialog>
      <el-form ref="lotInfoDetailForm" :model="lotInfoDetailForm" label-width="150px" :inline="false">
        <el-form-item prop="deviceId" label="塔机" :rules="ruleDeviceId">
          <el-select v-model="lotInfoDetailForm.deviceId" name="deviceId" :disabled="deviceDisabled"
            @change="deviceChangeHandle" placeholder="请选择塔吊" size="mini">
        ...
        <el-form-item prop="displayHeight" label="塔机实际高度（米）" :rules="ruleDisplayHeight" :min="0">
          <el-input-number name="displayHeight" v-model="lotInfoDetailForm.displayHeight">
          </el-input-number>
        </el-form-item>
