...
<template>
  ...
  <div id="lot-position-dialog" class="lot-position-dialog">
    <el-dialog :modal="false" width="400px" top="10vh" left="100" :lock-scroll="true" :close-on-click-modal="false"
      :close-on-press-escape="true" :visible.sync="TajiPositionDialog.show" @opened="openedDialogHandle"
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      TajiPositionDialog: {
        get: function () {
          return this.$store.state.loT.TajiPositionDialog
        },
        set: function (newValue) {
          this.$store.state.loT.TajiPositionDialog = newValue
        }
      },
    ...
    methods: {
      ...
      openedDialogHandle() {
        ...
        console.log('this.TajiPositionDialog', this.TajiPositionDialog)
        this.tajiPositionForm.globalOffset = this.TajiPositionDialog.position
        //   this.tajiPositionForm.rotate.x = this.TajiPositionDialog.rotate.x
