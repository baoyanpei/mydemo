      ...
      <el-form ref="tajiPositionForm" :model="tajiPositionForm" label-width="80px" :inline="true">
        ...
        <el-tabs type="border-card" style="height: 650px;">
          <el-tab-pane label="轿箱设置">
            ...
            <div style="font-size: 18px;margin: 10px;padding: 10px;border-bottom: 1px solid #eeeeee;">平移</div>
            <el-form-item label="X轴方向">
              <el-input-number v-model="tajiPositionForm.globalOffset.x"
                @change="lotPositionHandle('elevator_position')">
              </el-input-number>
            </el-form-item>
            <el-form-item label="Y轴方向">
              <el-input-number v-model="tajiPositionForm.globalOffset.y"
                @change="lotPositionHandle('elevator_position')">
              </el-input-number>
            </el-form-item>
            <el-form-item label="Z轴方向">
              <el-input-number v-model="tajiPositionForm.globalOffset.z"
                @change="lotPositionHandle('elevator_position')">
              </el-input-number>
            </el-form-item>
            <div style="font-size: 18px;margin: 10px;padding: 10px;border-bottom: 1px solid #eeeeee;">高度</div>
            <el-form-item label="模型高度">
              <el-input-number v-model="tajiPositionForm.height" @change="lotPositionHandle('height')" :min="1">
              </el-input-number>
            </el-form-item>

            <div style="font-size: 18px;margin: 10px;padding: 10px;border-bottom: 1px solid #eeeeee;">旋转</div>
            <el-form-item label="初始方向">
              <el-input-number v-model="tajiPositionForm.rotate.z" @change="lotPositionHandle('elevator_rotate_z')">
              </el-input-number>
            </el-form-item>
          </el-tab-pane>
          <el-tab-pane label="大柱设置">配置管理</el-tab-pane>
          <el-tab-pane label="其他设置">
            <div style="font-size: 18px;margin: 10px;padding: 10px;border-bottom: 1px solid #eeeeee;">缩放</div>
