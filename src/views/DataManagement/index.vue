    ...
    <div style="">
      <el-row>
        <el-col :span="24">
          <!--头部开始-->
          <div class="top">
            <el-select v-model="value1" placeholder="请选择" @change="optionschange" style="width: 120px;margin-top: 7px;">
              <el-option
            ...
            <el-button type="primary" @click=uploadfnc round style="float: right;margin-top: 7px;background-color: #409EFF;">上传资料</el-button>
          </div>
          <el-dialog title="上传资料" :visible.sync="dialogVisible" width="670px" :modal-append-to-body='false'>
            <div class="uploadbox">
              <div class="uploadbox_left" style="width: 100px;float: left;line-height: 30px;text-align: center"><span>上传文件:</span></div>
              ...
              <el-dialog title="上传图片预览" :visible.sync="photodialogVisible" :modal-append-to-body='false'>
                <img width="100%" :src="dialogImageUrl" alt="">
              </el-dialog>
            </div>
            <div class="uploadbox">
              <div class="uploadbox_left" style="width: 100px;float: left;line-height: 30px;text-align: center"><span>资料名称:</span></div>
              <el-input v-model="datainput" placeholder="请输入内容" style="width: 400px;float: left"></el-input>
            </div>
            <br><br><br>
            <div class="uploadbox">
              <div class="uploadbox_left" style="width: 100px;float: left;line-height: 30px;text-align: center"><span>类型:</span></div>
              <el-cascader v-model="datavalue" :options="dataoptions" @change="dataoptionshandleChange"></el-cascader>
            </div>
          ...
          <el-tabs :tab-position="tabPosition" style="min-height: 200px" @tab-click="tabpanechange">
            <el-tab-pane v-for="obj in this.labelbox" :label="obj.label">
                  <!--内容主体-->
              <!--搜索框-->
              ...
              <!--二级小tab-->
              <el-radio-group v-model="secondtab" v-show="secondtabshow" style="margin-bottom: 30px;margin-top: 20px">
                <el-radio-button v-for="item in obj.btnbox" @click.native.prevent="radioclickfnc(item)" :label="item.prof_name">{{item.prof_name}}</el-radio-button>
              </el-radio-group>
               <!--表格-->
                <div class="tabeldiv">
                  <!--国家标准表格   :cell-style="{'text-align':'center'}"-->
                  <el-table ref="singleTable" v-show="tabledata1show" :data="tableData" @selection-change="handleSelectionChange">
                    <el-table-column type="selection" width="55"></el-table-column>
                    <el-table-column prop="fileid" label="序号" width="55" :cell-style="{'text-align':'center'}"></el-table-column>
                  ...
                  <!--项目部资料表格-->
                  <el-table ref="singleTable" v-show="tabledata2show" :data="projecttabledata" :header-cell-style="{'text-align':'center'}" :cell-style="{'text-align':'center'}" @selection-change="handleSelectionChange">
                    <el-table-column type="selection" width="55"></el-table-column>
                  ...
                  <el-dialog title="资料下载" :visible.sync="projectdialog" width="500px" :modal-append-to-body='false'>
                    <span>点击下载，下载模板资料</span>
                    <div class="projectsmall">
                        <span style="float: left"><i class="el-icon-tickets" style="margin-right: 15px"></i>这是一个文件</span>
                      <a href="javascript:void(0)"><span style="float: right;color: #1bb1f4">下载</span></a>
                      </div>
                    <span slot="footer" class="dialog-footer">
    ...
    methods:{
      optionschange(index){//项目部资料
        if(index==1){
          ...
          this.labelbox=[{label:"安全",id:'1',btnbox:this.buttonbox},{label:"质量",id:"2",btnbox:this.buttonbox},
                         {label:"技术",id:'3',btnbox:this.buttonbox},{label:"施工",id:"4",btnbox:this.buttonbox},
                         {label:"资料",id:'5',btnbox:this.buttonbox},{label:"财务",id:"6",btnbox:this.buttonbox},
                         {label:"物资",id:'7',btnbox:this.buttonbox},{label:"劳务",id:"8",btnbox:this.buttonbox},
                         {label:"法务预算",id:'9',btnbox:this.buttonbox},{label:"综合",id:"10",btnbox:this.buttonbox},
      ...
      getprojectdata(){//项目部资料
        ...
        this.$store.dispatch('Allpersondata', param).then((data) => {
          ...
          this.projecttabledata.forEach(item=>{
            item["projectid"]=(this.projectdatapage-1)*20+this.projecttabledata.indexOf(item)+1
      ...
      dataoptionshandleChange(){//上传资料联级列表
