          ...
          >
            <div class="fabudiv" style="width: 100%;margin-bottom: 15px;position: relative;">
              ...
              <div
                class="ding"
                v-show="dingshow"
                style="padding-top:20px;position: absolute;background-color: #fff;top: -20px;right: -270px;width: 250px;height: 400px;"
              >
                <el-cascader
                  :props="props"
                  :options="grouparr"
              ...
              <div class="taskbox1">
                ...
                >
                  <el-button
                    slot="append"
                    @click="queryFun"
                    style="background-color:#409EFF;width: 100px;color: #fff;"
                  >查询</el-button>
                </el-input>
                <span style="font-size: 14px;margin-left: 50px" @click="jinjianclick">
                  精简筛选条件&nbsp;&nbsp;
                ...
                >
                  ...
                  <div class="details_top">
                    <img
                      ...
                      alt
                      style="width: 25px;height: 25px;margin-left: 10px;margin-top: 5px;float: left;"
                    />
                    <span class="details_top_span">{{item.stateall}}</span>
                    <span class="details_top_span">—</span>
                    <span class="details_top_span">{{item.questions_type}}</span>
                    <div
                      class="statebox"
                  ...
                  <div class="imgbox">
                    ...
                    <div
                      class="imgbox_yuan"
                      v-show="item.imgboxyuanshow"
                    >{{item.obj.info.comment_count}}</div>
                  </div>
                  <div class="imgbox_right">
                    <span class="titleword" @click="infoshow(item)">{{item.title}}</span>
                    <div class="peoplebox">
                      <span class="originator_span">
                        发起人:
                        <span
                          style="color: #383838"
                          @click="handleNameClick(item.person_id1)"
                        >{{item.originator}}</span>
                      </span>
                      <!--header   负责人-->
                      <span
                        class="originator_span"
                        style="border-left: 1px solid #a8a8a8;padding-left: 10px;"
                        v-show="item.xian"
                      >
                        负责人:
                        <span
                          style="color: #383838"
                          @click="handleNameClick(item.person_id2)"
                        >{{item.header}}</span>
                      </span>
                      <!--qualiter   质检人-->
                      <span
                      ...
                      >
                        ...
                        <span
                          style="color: #383838"
                          @click="handleNameClick(item.person_id3)"
                        >{{item.qualiter}}</span>
                      </span>
                    </div>
                    <span class="created_time">
                      发布时间:
                      <span style="color: #383838">{{item.created}}</span>
                    </span>
                    <div class="imgbox_right_bottom">
                      <div
                        class="logobox"
                        :class="{'yellow':item.stateall==='任务','zise':item.stateall==='会议','lvse':item.stateall==='通知','anquan':item.stateall==='安全巡检','ziliao':item.stateall==='资料'}"
                      >{{item.stateall}}</div>
              ...
              <div class="taskbox1">
                ...
                <div v-show="jinjianshow">
                  ...
                  <template>
                    <el-select
                      v-model="statevalue"
                      clearable
                      @change="mytaskkeyselectfnc(statevalue)"
                      placeholder="所有"
                      style="width: 120px"
                      class="btn1"
                    >
                      <el-option
                        v-for="item in mytaskoptions"
                        :key="item.statevalue"
                        :label="item.label"
                        :value="item.label"
                      ></el-option>
                ...
                >
                  ...
                  <div class="imgbox_right">
                    ...
                    <span class="created_time">
                      发布时间:
                      <span style="color: #383838">{{item.sendTime}}</span>
                    </span>
                    <!--{{item.aaaid}}-->
                    <div class="imgbox_right_bottom">
                      <div
      ...
      <el-col :span="12" style>
        <div class="rilitop">
          ...
          <div class="taskstate" style="background-color: #3692ff">
            ...
            <img
              src="../../../static/taskindex/待认领.png"
              alt
              style="width: 55px;height: 60px;margin-top: 20px"
            />
          </div>
          <div class="taskstate" style="background-color: #bc1a1a;">
            ...
            <img
              src="../../../static/taskindex/发布.png"
              alt
              style="width: 55px;height: 55px;margin-top: 20px"
            />
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      listbox: [],
      mytaskoptions: [
        { label: '待办', value: 'TodoList' },
        { label: '待认领', value: 'BackLog' },
        { label: '待阅', value: 'MatterRead' },
      ], //我的任务状态
      statevalue: '',
      boxinfo: [
        {
  ...
  methods: {
    ...
    infoshow(index) {
      console.log('详情页面展示信息-task-index', index)
