...
const project = {
  ...
  mutations: {
    ...
    SET_INFO_DIALOG: async (state, data) => {
      // 任务大厅，任务详情
    ...
    SET_RELEASE_DIALOG: async (state, data) => {
      //任务发布
      console.log("任务发布SetRelease");
    },

    SET_PERSON_INOUT_DIALOG: async (state, data) => {
      // 人员考勤
      if (data.show === true) {
    ...
    SET_PERSON_LIST_DIALOG: async (state, data) => {
      // 人员信息
      if (data.show === true) {
        const _hasPermission = await hasPermissionToOperation({
          project_id: state.project_id,
    ...
    SET_CESHI_DIALOG: async (state, data) => {
      // 测试
      if (data.show === true) {
        const _hasPermission = await hasPermissionToOperation({
          project_id: state.project_id,
    ...
    SET_PERSON_NOW_IN_DIALOG: async (state, data) => {
      // 场内人员
      //show:true false
      if (data.show === true) {
        const _hasPermission = await hasPermissionToOperation({
    ...
    SET_PERSON_FULLCALENDER_DIALOG: async (state, data) => {
      // 日历窗口
      //show:true false
  ...
  actions: {
    // 查询人员
    QueryProjectPerson({ commit }, param) {
      return new Promise((resolve, reject) => {
        queryProjectPerson(param)
          .then(response => {
    ...
    // 查询项目组人员
    QueryProjectPersons({ commit }, param) {
      return new Promise((resolve, reject) => {
        queryProjectPerson(param)
          .then(response => {
            commit("SET_PROJECT_PERSON_LIST", response.data);
    ...
    // 查询入场识别率的人员
    QueryProjectPersonsByFacePercent({ commit }, param) {
      return new Promise((resolve, reject) => {
        queryProjectPerson(param)
          .then(response => {
    ...
    // 查询项目分组
    QueryProjectGroups({ commit }, param) {
      return new Promise((resolve, reject) => {
        queryProjectGroup(param)
          .then(response => {
    ...
    // 查询项目分组
    QueryProjectCount({ commit }, param) {
      return new Promise((resolve, reject) => {
        queryProjectCount(param)
          .then(response => {
            const _data = response.data;
    ...
    // 查询获取最新的进出person
    QueryProjectGatePerson({ commit }, param) {
      return new Promise((resolve, reject) => {
        queryProjectGatePerson(param)
          .then(response => {
            const _data = response.data;
    ...
    SetPersonInfoDialog({ commit }, param) {
      return new Promise((resolve, reject) => {
        commit("SET_PERSON_INFO_DIALOG", param);
        resolve();
      });
    },
    SetPersonInoutDetailDialog({ commit }, param) {
      return new Promise((resolve, reject) => {
        commit("SET_PERSON_INOUT_DETAIL_DIALOG", param);
        resolve();
      });
    },
    SetPersonQuitLeftDialog({ commit }, param) {
      return new Promise((resolve, reject) => {
        commit("SET_PERSON_QUIT_LEFT_DIALOG", param);
        resolve();
      });
    },
    SetWorktimeFullCalenderDialog({ commit }, param) {
      return new Promise((resolve, reject) => {
        commit("SET_WORKTIME_FULLCALENDAR_DIALOG", param);
        resolve();
      });
    },
    SetPersonInoutDialog({ commit, rootState }, param) {
      return new Promise((resolve, reject) => {
    ...
    SetPersonListDialog({ commit, rootState }, param) {
      return new Promise((resolve, reject) => {
    ...
    ceshipro({ commit, rootState }, param) {
      return new Promise((resolve, reject) => {
    ...
    SetPersonNowInDialog({ commit }, param) {
      return new Promise((resolve, reject) => {
    ...
    // 日历窗口
    SetPersonFullCalenderDialog({ commit }, param) {
      return new Promise((resolve, reject) => {
        console.log("param", param);
    ...
    // 识别率窗口
    SetPersonFacePersonDialog({ commit }, param) {
      return new Promise((resolve, reject) => {
    ...
    // 人员考勤person详细窗口
    SetInOutPersonDialog({ commit }, param) {
      return new Promise((resolve, reject) => {
    ...
    SetPersonNowinChanged({ commit }, param) {
      return new Promise((resolve, reject) => {
        commit("SET_PERSON_NOW_IS_CHANGED");
        resolve();
      });
    },
    SetPersonListChanged({ commit }, param) {
      return new Promise((resolve, reject) => {
        commit("SET_PERSON_LIST_CHANGED");
        resolve();
      });
    },
    SetPersonInfoChanged({ commit }, param) {
      return new Promise((resolve, reject) => {
    ...
    // 查询项目进出人员列表
    QueryProjectPersonInout({ commit }, param) {
      return new Promise((resolve, reject) => {
        queryProjectPersonInout(param)
          .then(response => {
    ...
    // 查询项目场内人员列表
    QueryProjectPersonNowIn({ commit }, param) {
      return new Promise((resolve, reject) => {
        queryProjectPersonInout(param)
          .then(response => {
            const _data = response.data;
    ...
    // 查询一段时间内用户在场天数
    QueryProjectPersonInDay({ commit }, param) {
      return new Promise((resolve, reject) => {
        queryProjectPersonInDay(param)
          .then(response => {
            const _data = response.data;
    ...
    // 清场
    QueryProjectPersonGoOut({ commit }, param) {
      return new Promise((resolve, reject) => {
        queryProjectPersonGoOut(param)
          .then(response => {
            const _data = response.data;
    ...
    // 设置人证校验是否为本人
    queryLogsPersonComfirm({ commit }, param) {
      return new Promise((resolve, reject) => {
        queryLogsPersonComfirm(param)
          .then(response => {
            const _data = response.data;
    ...
    // 进出车辆日志查询
    QueryVehicleGate({ commit }, param) {
      return new Promise((resolve, reject) => {
        queryVehicleGate(param)
          .then(response => {
            const _data = response.data;
            // console.log('queryLogsPersonComfirm', _data)
            resolve(_data);
    ...
    // 查询项目人员进出记录
    queryInOutDetail({ commit }, param) {
      return new Promise((resolve, reject) => {
        queryInOutDetail(param)
          .then(response => {
            const _data = response.data;
    ...
    // 查询项目人员进出记录
    queryPersonWorktime({ commit }, param) {
      return new Promise((resolve, reject) => {
        queryPersonWorktime(param)
          .then(response => {
            const _data = response.data;
    ...
    // 查询项目人员进出记录
    queryProjectWorktime({ commit }, param) {
      return new Promise((resolve, reject) => {
        queryProjectWorktime(param)
          .then(response => {
            const _data = response.data;
    ...
    // 根据用户ID信息查询档案资料
    QueryPersonDatum({ commit }, param) {
      return new Promise((resolve, reject) => {
        queryPersonDatum(param)
          .then(response => {
            const _data = response.data;
    ...
    UpdateDutyWeek({ commit }, param) {
      return new Promise((resolve, reject) => {
        updateDutyWeek(param)
          .then(response => {
            // const _data = response.data
