...
const user = {
  ...
  actions: {
    ...
    // 用户名登录
    // source = 3
    loginByWXQRCode({ commit }, userInfo) {
      return new Promise((resolve, reject) => {
        console.log("userInfo", userInfo);
        loginByWXQRCode(userInfo.code, userInfo.status)
          .then(res => {
